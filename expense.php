<?php  
  class Expense extends Base {
    ...
    // Expenses of Current Month(Datewise) // Research Needed
    ...
    // Returns all rows from expense table with category
    public function allexpWithCategory($UserId) {
    ...
    // Delete a particular expense record(with given expense id)
