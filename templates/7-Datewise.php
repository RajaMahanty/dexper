        ...
        <div class="row">
            <div class="col-12 col-m-12 col-sm-12" >
                <div class="card">
                    ...
                    <h1 style="display: block; color: var(--main-color); font-family: 'Source Sans Pro'">Datewise Expense Report</h1>
								<div class="form-send">
									<label style="font-family: 'Source Sans Pro'; color: var(--main-color); font-size: 1.3em; ">From:</label><br><br>
                                ...
                                <div clas="form-send">
									<label style="font-family: 'Source Sans Pro'; color: var(--main-color); font-size: 1.3em; ">To:</label><br><br>
