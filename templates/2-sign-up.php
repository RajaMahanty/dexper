...
<head>
    ...
    <link rel="icon" href="../static/images/logo-transparent-svg.svg" sizes="16x16" type="image/png">
...
<body>
    ...
    <div class="container">
        ...
        <div class="img-container">
            ...
            <img src="../static/images/registration1.png" alt="">
        </div>

        <form action="2-sign-up.php" method="post" id="form" onsubmit="return validate()" enctype="multipart/form-data">

            <!-- Image Upload -->
            <div class="image-preview" id="imagePreview" onclick="document.getElementById('imageUpload').click();" style="cursor: pointer;">
                <img src="" alt="Image Preview" class="image-preview__image" id="profileDisplay">
                <span class="image-preview__default-text"><img src="../static/images/add-image.png" alt=""></span>
            </div>
            <!-- <label for="imageUpload" class="user-pic-btn" style="cursor: pointer; border: 1px solid #000; padding: 5px 10px; border-radius: 5px;">Add Photo</label> -->
            ...
            <div class="group">
                ...
                <div class="form-control">
                    ...
                    <br>
                    <small></small>
                    <span id="email_response" style="font-family: 'Source Sans Pro'; font-size:0.8em ; color:red; font-weight:bold"></span>
                </div>
            ...
            <button class="btn" type="submit" value="Submit" name="register">Complete</button>
            <br>
            <?php
        ...
        $(document).ready(function() {
            ...
            $("#email").keyup(function() {
                ...
                if (email != '') {
                    ...
                    $("#email_response").css({'margin-bottom': '15px'});
                    $.ajax({
                        url: '../ajaxfile.php',
                        type: 'post',
                        data: { email: email },
