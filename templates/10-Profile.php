                    ...
                    <form action="">
                        ...
                        <div><br>
                            <a href="11-changepass.php">
                                <button type="button" class="pressbutton" name="submit">Change Password</button>
                            </a>
                            <a href="delete_account.php" style="color: white; background-color: red; padding: 10px 20px; text-decoration: none; border-radius: 5px;">
                                Delete Account
                            </a>
                        </div>
