        ...
        <div class="col-12 col-m-12 col-sm-12" >
            <div class="card">
                ...
                <form action="" method="post">
                    <h1 style="display: block; color: var(--main-color); font-family: 'Source Sans Pro'">Yearwise Expense Report</h1>
                    <div>
                        <label style="font-family: 'Source Sans Pro'; color: var(--main-color); font-size: 1.3em; ">From:</label><br>
                    ...
                    <div>
                        <label style="font-family: 'Source Sans Pro'; color: var(--main-color); font-size: 1.3em; ">To:</label><br>
                        <input class="text-input yearpicker" type="text" id="yrto" value="" name="yrto" required="true" style="width: 100%; padding-top: 8px; "><br><br>
                        <small style="font-family:'Source Sans Pro'; color: var(--main-color); font-size: 1.01em;"><?php if(isset($error)){echo $error;} ?></small>
                    </div>
