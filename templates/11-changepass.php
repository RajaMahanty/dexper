                ...
                <div class="card">
                    ...
                    <form action="" method="post" onsubmit="return validate()" id="form">
								...
								<div class="formcontrol">
									<label style="color: var(--main-color); font-family: 'Source Sans Pro'; font-size: 1.3em; ">Current Password:</label><br>
									<input type="password" class="text-input" name="oldpass" id="oldpass" value="" required="true" style="padding-top: 10px; "><br>
                                    <small></small>
                                </div>
                                <div class="formcontrol">
									<label style="color: var(--main-color); font-family: 'Source Sans Pro'; font-size: 1.3em; ">New Password:</label><br>
									<input type="password" class="text-input" name="newpass" id="newpass" value="" required="true" style="padding-top: 10px; "><br>
                                    <small></small>
                                </div>
                                <div class="formcontrol">
									<label style="color: var(--main-color); font-family: 'Source Sans Pro'; font-size: 1.3em; ">Re-Type Password:</label><br>
